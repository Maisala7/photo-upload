...
class notfState extends State<notf> {
  ...
  @override
  String date_of_accept_or_reject="";
  
  Widget build(BuildContext context) {
    print('!!!!!!!!!!!!!!');
    if (list[0]['date_of_accept']==null &&list[0]['date_of_reject']==null){
      print('1111111111111');
      setState(() {
        date_of_accept_or_reject="Not Yet Accepted Or Rejected";
      });
    }else if(list[0]['date_of_accept']==null){
      print('222222222222');
      setState(() {
        date_of_accept_or_reject = list[0]['date_of_reject'];
      });
    }else{
      print('3333333333');
      setState(() {
        date_of_accept_or_reject=list[0]['date_of_accept'];
      });
    }
    var box = card(
        language,
        list[0]['FirstName'] +
            ...
            list[0]['FourtName'],
            list[0]['Birthdate'],
            list[0]['Placeof_Birth'],
        // date_of_accept_or_reject,
        // list[0]['statu'],
        list[0]['Blood_Type'],
        list[0]['Job'],
        list[0]['Address'],
        ...
        children: [
          Row(children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 30, left: 10),
              child: Text(
                'Your card accepted/rejeced date is:',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                ),
